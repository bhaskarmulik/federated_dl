...
def test_tensor_creation():
    ...
    print("  ✓ tensor creation & properties")
...
def test_tensor_static_constructors():
    ...
    r = Tensor.randn(5, 5)
    assert r.shape == (5, 5)
    print("  ✓ static constructors (zeros, ones, randn)")
...
def test_grad_chain_rule():
    ...
    print("  ✓ chain rule: (x+2)(x+3) at x=1 → 7.0")
...
def test_grad_polynomial():
    ...
    print("  ✓ polynomial: 3x^2+4x-1 at x=2 → 19.0")
...
def test_grad_accumulation():
    ...
    print("  ✓ gradient accumulation across multiple backward passes")
...
def test_grad_matmul():
    ...
    print("  ✓ matmul gradients (A and B)")
...
def test_grad_broadcast_add():
    ...
    print("  ✓ broadcast add gradient un-reduction")
...
def test_no_grad():
    ...
    print("  ✓ no_grad suppresses graph construction")
...
def test_state_dict_bytes():
    ...
    print("  ✓ state_dict_to_bytes / bytes_to_state_dict roundtrip")
...
def test_gradcheck_exp_log():
    ...
    print("  ✓ gradcheck: exp → log composition")
