...
def test_elemwise_broadcast():
    ...
    print("  ✓ elementwise broadcast (1,3)*(3,1) gradient un-reduction")
...
def test_pow_backward():
    ...
    print("  ✓ pow3 backward: 3x² at [2,3,4] → [12,27,48]")
...
def test_mean_backward():
    ...
    print("  ✓ mean() backward (1/N scaling)")
...
def test_sigmoid():
    ...
    print("  ✓ Sigmoid forward + backward")
...
def test_logsoftmax_shape():
    ...
    print("  ✓ LogSoftmax shape + backward runs")
...
def test_im2col_roundtrip():
    ...
    print("  ✓ im2col output shape correct")
...
def test_conv2d_forward_vs_manual():
    ...
    print("  ✓ Conv2d forward matches manual correlation")
...
def test_conv2d_backward():
    ...
    print("  ✓ Conv2d backward — correct gradient shapes")
...
def test_maxpool2d_forward():
    ...
    print("  ✓ MaxPool2d forward (2×2 stride=2)")
...
def test_maxpool2d_backward():
    ...
    print("  ✓ MaxPool2d backward (gradient count equals output elements)")
...
def test_batchnorm_train():
    ...
    print("  ✓ BatchNorm2d train: channels normalized + backward runs")
...
def test_layernorm():
    ...
    out.sum().backward()
    assert x.grad is not None
    print("  ✓ LayerNorm forward + backward runs")
...
def test_dropout_train():
    ...
    print(f"  ✓ Dropout train: ~{zero_frac*100:.0f}% zeros (expected ~50%)")
...
def test_dropout_eval():
    ...
    print("  ✓ Dropout eval: identity pass-through")
